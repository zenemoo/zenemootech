...
public class MainActivity extends BridgeActivity {
    ...
    private static final String TEAM_PORTAL_URL = "https://www.zenemoo.in/team-portal";
    private static final String PREFS_NAME = "ZenemooTeamBiometricPrefs";
    ...
    private static final String OFFLINE_HTML = "<!DOCTYPE html>" +
            ...
            "<title>Zenemoo Team - Connection Error</title>" +
            "<style>" +
            ...
            "</style></head><body>" +
            "<div class=\"card\">" +
            "<div class=\"logo\">Zenemoo Team</div>" +
            "<div class=\"badge\">Enterprise Team Access Portal</div>" +
            "<h2>You're Offline</h2>" +
            "<p>Please check your network settings and try again to access the Zenemoo Enterprise Team Portal.</p>" +
            "<button class=\"btn\" onclick=\"window.location.href='" + TEAM_PORTAL_URL + "'\">Retry Connection</button>" +
            "</div></body></html>";
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                    if (request != null && request.isForMainFrame()) {
                        view.loadDataWithBaseURL(TEAM_PORTAL_URL, OFFLINE_HTML, "text/html", "UTF-8", null);
                    }
                    if (defaultClient != null) {
