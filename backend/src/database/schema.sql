...
INSERT INTO talent_supported_languages (language, code, status) VALUES
  ...
  ('Awadhi', 'AWA', 'active'),
  ('Badaga', 'BAD', 'active'),
  ('Baghelkhandi / Bagheli', 'BAG', 'active'),
  ('Bagri', 'BAG', 'active'),
  ('Balti', 'BAL', 'active'),
  ('Banjari / Lambadi', 'BAN', 'active'),
  ('Beary', 'BEA', 'active'),
  ('Bengali', 'BN', 'active'),
  ('Bhili / Bhilodi', 'BHI', 'active'),
  ('Bhojpuri', 'BHO', 'active'),
  ('Bhumij', 'BHU', 'active'),
  ('Bhutia', 'BHU', 'active'),
  ('Bishnupriya Manipuri', 'BIS', 'active'),
  ('Bodo', 'brx', 'active'),
  ('Bundelkhandi / Bundeli', 'BUN', 'active'),
  ('Chakhesang / Chokri', 'CHA', 'active'),
  ('Chakma', 'CHA', 'active'),
  ('Chang', 'CHA', 'active'),
  ('Chhattisgarhi', 'CHH', 'active'),
  ('Coorgi / Kodava', 'COO', 'active'),
  ('Dangi', 'DAN', 'active'),
  ('Deori', 'DEO', 'active'),
  ('Dhundhari', 'DHU', 'active'),
  ('Dimasa', 'DIM', 'active'),
  ('Dogri', 'doi', 'active'),
  ('English', 'EN', 'active'),
  ('Gadaba', 'GAD', 'active'),
  ...
  ('Hmar', 'HMA', 'active'),
  ('Ho', 'HO', 'active'),
  ('Jaintia / Pnar', 'JAI', 'active'),
  ('Jaunsari', 'JAU', 'active'),
  ('Juang', 'JUA', 'active'),
  ('Kabui / Rongmei', 'KAB', 'active'),
  ('Kangri', 'KAN', 'active'),
  ('Kannada', 'KN', 'active'),
  ('Karbi', 'KAR', 'active'),
  ('Kashmiri', 'KS', 'active'),
  ('Khandeshi', 'KHA', 'active'),
  ('Kharia', 'KHA', 'active'),
  ('Khasi', 'KHA', 'active'),
  ('Khortha', 'KHO', 'active'),
  ('Kinnauri', 'KIN', 'active'),
  ('Kokborok (Tripuri)', 'KOK', 'active'),
  ('Kolami', 'KOL', 'active'),
  ('Kom', 'KOM', 'active'),
  ('Konkani', 'kok', 'active'),
  ('Konyak', 'KON', 'active'),
  ...
  ('Kui', 'KUI', 'active'),
  ('Kumaoni', 'KUM', 'active'),
  ('Kurukh / Oraon', 'KUR', 'active'),
  ('Kuvi', 'KUV', 'active'),
  ('Ladakhi', 'LAD', 'active'),
  ('Lepcha', 'LEP', 'active'),
  ('Limbu', 'LIM', 'active'),
  ('Lotha', 'LOT', 'active'),
  ('Magahi / Magadhi', 'MAG', 'active'),
  ('Maithili', 'mai', 'active'),
  ('Malayalam', 'ML', 'active'),
  ('Malto / Paharia', 'MAL', 'active'),
  ('Malvi', 'MAL', 'active'),
  ('Mandeali', 'MAN', 'active'),
  ('Manipuri (Meitei)', 'mni', 'active'),
  ('Mao', 'MAO', 'active'),
  ('Marathi', 'MR', 'active'),
  ('Marwari', 'MAR', 'active'),
  ('Mewari', 'MEW', 'active'),
  ('Mewati', 'MEW', 'active'),
  ('Mishmi', 'MIS', 'active'),
  ('Mizo (Lushai)', 'MIZ', 'active'),
  ('Monpa', 'MON', 'active'),
  ('Munda', 'MUN', 'active'),
  ('Mundari', 'MUN', 'active'),
  ('Nagpuri / Sadri', 'NAG', 'active'),
  ('Nepali', 'NE', 'active'),
  ('Nicobarese', 'NIC', 'active'),
  ('Nimadi', 'NIM', 'active'),
  ('Nishi / Nyishi', 'NIS', 'active'),
  ('Nocte', 'NOC', 'active'),
  ('Odia', 'OR', 'active'),
  ('Paite', 'PAI', 'active'),
  ('Phom', 'PHO', 'active'),
  ('Punjabi', 'PA', 'active'),
  ('Rabha', 'RAB', 'active'),
  ('Rajasthani', 'RAJ', 'active'),
  ('Rajbanshi / Kamtapuri', 'RAJ', 'active'),
  ('Rengma', 'REN', 'active'),
  ('Sangtam', 'SAN', 'active'),
  ('Sanskrit', 'SA', 'active'),
  ('Santali', 'sat', 'active'),
  ...
  ('Tangsa', 'TAN', 'active'),
  ('Telugu', 'TE', 'active'),
  ('Thado / Kuki', 'THA', 'active'),
  ('Tiwa / Lalung', 'TIW', 'active'),
  ('Tulu', 'TUL', 'active'),
  ('Vaiphei', 'VAI', 'active'),
  ('Wagdi', 'WAG', 'active'),
  ('Wancho', 'WAN', 'active'),
  ('Yimkhiung', 'YIM', 'active'),
  ('Zeliang', 'ZEL', 'active'),
  ('Other', 'OTH', 'active')
