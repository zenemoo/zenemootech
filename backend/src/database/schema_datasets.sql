...
DROP POLICY IF EXISTS "Public read access for dataset folders" ON public.dataset_folders;
CREATE POLICY "Public read access for dataset folders" ON public.dataset_folders
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Public read access for dataset files" ON public.dataset_files;
...
DROP POLICY IF EXISTS "Admin full management for dataset folders" ON public.dataset_folders;
