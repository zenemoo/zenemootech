    ...
    <AnimatePresence>
      ...
      >
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <a
                  ...
                  className="px-3.5 py-2 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-xs font-mono font-bold flex items-center gap-2 transition-all shadow-sm active:scale-95 cursor-pointer"
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 text-purple-300 border border-purple-500/30 text-xs font-mono font-bold flex items-center gap-2 cursor-pointer transition-all active:scale-95 disabled:opacity-50"
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="p-2 rounded-xl text-slate-400 hover:text-white bg-white/5 hover:bg-white/10 transition-colors cursor-pointer border border-white/10 ml-1"
          ...
          {/* ========================================================= */}
          <div className="p-4 sm:p-6 pt-0 space-y-6 overflow-y-auto flex-1">
            {/* ========================================================= */}
            {/* SEARCH AND FILTER BAR */}
            {/* ========================================================= */}
            <div className="glass-panel p-4 rounded-2xl border border-white/10 bg-white/[0.02] space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-center">
                ...
                <div className="lg:col-span-4 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/80 border border-white/15 text-white placeholder:text-slate-500 text-xs font-mono focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                  />
                  {searchQuery && (
                    <button
                ...
                <div className="lg:col-span-2 flex items-center justify-end">
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 border border-white/10 text-xs font-mono font-bold flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95"
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="glass-panel p-4 sm:p-5 rounded-2xl border border-cyan-500/20 bg-cyan-500/[0.03] flex items-center justify-between shadow-lg shadow-cyan-500/5">
              ...
              {/* Pending Card */}
              <div className="glass-panel p-4 sm:p-5 rounded-2xl border border-amber-500/20 bg-amber-500/[0.03] flex items-center justify-between shadow-lg shadow-amber-500/5">
                <div className="space-y-1">
              ...
              {/* Accepted Card */}
              <div className="glass-panel p-4 sm:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.03] flex items-center justify-between shadow-lg shadow-emerald-500/5">
                <div className="space-y-1">
              ...
              {/* Rejected Card */}
              <div className="glass-panel p-4 sm:p-5 rounded-2xl border border-red-500/20 bg-red-500/[0.03] flex items-center justify-between shadow-lg shadow-red-500/5">
                <div className="space-y-1">
            ...
            <div className="block md:hidden space-y-4">
              {filteredApps.length === 0 ? (
                <div className="glass-panel p-8 text-center rounded-2xl border border-white/10 space-y-3">
                ...
                paginatedApps.map((app) => {
                  ...
                  return (
                    <div
                      key={app.id}
                      className="glass-panel p-4 rounded-2xl border border-white/10 bg-white/[0.02] space-y-3.5 shadow-md"
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1 rounded bg-white/5 text-slate-400 text-[10px]"
                          >
                      ...
                      <div className="pt-2 border-t border-white/10 flex items-center justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-cyan-500/20 text-cyan-300 border border-white/10 text-xs font-mono flex items-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-purple-500/20 text-purple-300 border border-white/10 text-xs font-mono flex items-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 text-xs font-mono flex items-center gap-1"
                        >
            ...
            {totalFilteredCount > 0 && (
              <div className="glass-panel p-4 rounded-2xl border border-white/10 bg-white/[0.02] flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-slate-400">
                <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <select
                      ...
                      className="px-2.5 py-1 rounded-lg bg-slate-900 border border-white/15 text-white focus:outline-none text-xs font-bold"
                    >
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-white disabled:opacity-30 disabled:cursor-not-allowed border border-white/10"
                    >
          ...
          >
            ...
            <div className="flex items-center justify-end gap-3 pt-2 border-t border-white/10">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 font-bold text-xs font-mono cursor-pointer transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-bold text-xs font-mono shadow-lg shadow-red-500/20 flex items-center gap-2 cursor-pointer transition-all active:scale-95 disabled:opacity-50"
              >
                <Trash2 className="w-4 h-4" />
      ...
      {viewDetailApp && (
        <div className="fixed inset-0 z-[100050] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <motion.div
            ...
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.95, opacity: 0 }}
            className="bg-[#0d121f] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl shadow-cyan-500/10 space-y-6 text-slate-100 max-h-[90vh] overflow-y-auto"
          >
      ...
      {editNotesApp && (
        <div className="fixed inset-0 z-[100050] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <motion.div
            ...
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.95, opacity: 0 }}
            className="bg-[#0d121f] border border-purple-500/30 rounded-3xl p-6 sm:p-7 max-w-md w-full shadow-2xl shadow-purple-500/10 space-y-4 text-slate-100"
          >
