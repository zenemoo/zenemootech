...
import { Sparkles, ArrowRight, ShieldCheck, Heart, Github, Linkedin, Mail, Twitter, Check, CheckCircle2, X, Lock, FileText, Shield, Users, Database } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  return (
    <footer id="zenemoo-footer" className="relative z-10 bg-[#030406] text-slate-400 border-t border-white/10 pt-20 pb-12 font-sans">
