...
END:VCALENDAR`;
  ...
  return (
    <div className="min-h-screen bg-[#030406] text-slate-200 font-sans relative overflow-x-hidden w-full max-w-full selection:bg-cyan-500 selection:text-black flex flex-col justify-between">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-white/10 bg-[#070a11]/95 backdrop-blur-xl shadow-lg shadow-black/60 pt-[env(safe-area-inset-top,0px)]">
