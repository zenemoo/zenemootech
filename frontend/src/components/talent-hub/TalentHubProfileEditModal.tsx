      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 pb-32 flex flex-col justify-start">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch flex-1">
              ...
              <div className="p-5 sm:p-7 rounded-3xl bg-[#090e1b] border border-white/10 shadow-2xl flex flex-col justify-between min-h-[580px] h-full animate-in fade-in">
                ...
                <div className="pt-4 mt-6 border-t border-white/10 flex justify-end">
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-cyan-300 hover:text-white text-xs font-bold transition-all cursor-pointer"
                  >
              ...
              <div className="p-5 sm:p-7 rounded-3xl bg-[#090e1b] border border-white/10 shadow-2xl flex flex-col justify-between min-h-[580px] h-full animate-in fade-in">
                ...
                <div className="pt-4 mt-6 border-t border-white/10 flex items-center justify-between">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white text-xs font-bold transition-all cursor-pointer"
                  >
              ...
              <div className="p-5 sm:p-7 rounded-3xl bg-[#090e1b] border border-white/10 shadow-2xl flex flex-col justify-between min-h-[580px] h-full animate-in fade-in">
                ...
                <div className="pt-4 mt-6 border-t border-white/10 flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-extrabold text-xs transition-all cursor-pointer shadow-lg shadow-cyan-500/20"
                  >
          ...
          <aside className="lg:col-span-3 flex flex-col justify-between gap-4">
            ...
            <div className="p-5 rounded-3xl bg-[#090e1b] border border-white/10 shadow-xl space-y-4 text-center sm:text-left">
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 overflow-hidden flex items-center justify-center text-cyan-300 font-display font-extrabold text-xl shadow-md">
                    {avatarUrl ? (
                  ...
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-cyan-500 text-black flex items-center justify-center shadow-md">
                    <Camera className="w-3 h-3" />
                  </div>
                </div>

                <div className="min-w-0">
                  <h3 className="text-sm font-bold text-white truncate font-display">{displayName}</h3>
                  <p className="text-xs font-mono font-bold text-cyan-400 mt-0.5">{registrationCode}</p>
                  <div className="mt-1.5">
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-[10px] font-mono font-semibold">
            ...
            <div className="p-5 rounded-3xl bg-[#090e1b] border border-cyan-500/20 shadow-xl space-y-3.5">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2.5 py-0.5 rounded-lg bg-cyan-500/20 text-cyan-300 font-mono font-bold text-xs">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                {completeness.percent === 100
                  ...
                  : `${completeness.completed} of ${completeness.total} sections configured. Keep adding details to boost your project match rate.`}
              </p>
            </div>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-50 bg-[#080d1a]/98 backdrop-blur-md border-t border-white/10 px-4 sm:px-6 lg:px-8 py-3.5 shadow-2xl">
        <div className="max-w-7xl mx-auto flex flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            onClick={handleClose}
            disabled={isSaving}
            className="px-4 sm:px-5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 font-bold text-xs flex items-center gap-2 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            onClick={handleSaveProfile}
            disabled={isSaving}
            className="px-5 sm:px-7 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-extrabold text-xs flex items-center gap-2 shadow-lg shadow-cyan-500/25 transition-all cursor-pointer disabled:opacity-50"
          >
