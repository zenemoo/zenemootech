...
export const Languages: React.FC = () => {
  const primaryLangs = [
    { name: 'Hindi', script: 'हिन्दी', sample: 'अ आ इ', flag: '🇮🇳', badge: 'Primary', count: '8+ Members' },
    { name: 'English', script: 'Indian English', sample: 'A B C', flag: '🇬🇧', badge: 'Primary', count: '9+ Members' },
    { name: 'Odia', script: 'ଓଡ଼ିଆ', sample: 'ଅ ଆ ଇ', flag: '🏛️', badge: 'Primary', count: '7+ Members' },
  ];

  const onRequestLangs = [
    { name: 'Bengali', script: 'বাংলা', sample: 'অ আ ই', flag: '🌐', badge: 'On Request' },
    { name: 'Telugu', script: 'తెలుగు', sample: 'అ ఆ ఇ', flag: '🌐', badge: 'On Request' },
    { name: 'Tamil', script: 'தமிழ்', sample: 'அ ஆ இ', flag: '🌐', badge: 'On Request' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 text-base sm:text-lg">
            Our team includes native speakers across key Indian languages, ensuring cultural accuracy, correct dialect handling, and authentic pronunciation in every deliverable.
          </p>
        </div>
          ...
          {primaryLangs.map((lang, i) => (
            ...
            >
              ...
              <span className="inline-block px-3 py-1 rounded-full bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 text-[11px] font-mono font-semibold">
                {lang.badge} • {lang.count}
              </span>
            </div>
          ))}
        </div>

        {/* On Request Languages Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {onRequestLangs.map((lang, i) => (
            <div
              key={i}
            ...
            >
              ...
              <span className="inline-block px-2.5 py-0.5 rounded-full bg-purple-500/10 text-purple-300 border border-purple-500/30 text-[10px] font-mono">
                {lang.badge}
              </span>
            </div>
          ))}
        ...
        <div className="glass-panel rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          <div className="px-6 py-4 bg-gradient-to-r from-cyan-500/20 via-blue-600/20 to-purple-600/20 border-b border-white/10">
            <h3 className="text-base font-bold font-display text-white flex items-center gap-2">
              ...
              Language Capability Matrix &amp; Team Breakdown
            </h3>
          </div>
            ...
            <table className="w-full text-left font-mono text-xs text-slate-300">
              <thead className="bg-white/[0.03] text-slate-200 uppercase text-[11px] border-b border-white/10">
                <tr>
                  ...
                  <th className="p-4 text-center">Team Capacity</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                <tr className="hover:bg-white/[0.02]">
                  ...
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-cyan-400 font-bold">8+ members</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  ...
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-cyan-400 font-bold">9+ members</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  ...
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-emerald-400"><CheckCircle2 className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-cyan-400 font-bold">7+ members</td>
                </tr>
                <tr className="hover:bg-white/[0.02] text-slate-400">
                  <td className="p-4 font-bold text-slate-300 flex items-center gap-2">🌐 Other Indian Languages</td>
                  <td className="p-4 text-center text-amber-400"><Clock className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-amber-400"><Clock className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-amber-400"><Clock className="w-4 h-4 mx-auto" /></td>
                  <td className="p-4 text-center text-purple-400 font-semibold">On Request</td>
                </tr>
              </tbody>
            </table>
          </div>
